...
<div class="container-fluid mx-auto">
    <div class="payement-successful-box flex items-center justify-center flex-col gap-[16px]">
        ...
        <div class="success-message-box flex items-center justify-center mx-auto flex-col">
            <h1 class="text-[32px] font-[700] text-[#212529] break-auto-phrase">{{ __('Plan Successfully Downgraded!') }}</h1>
            <p class="text-[16px] font-[400] text-[#4B5563] break-auto-phrase">{{ __('Your plan has been downgraded successfully. Credit balance will be adjusted in the next billing cycle.') }}</p>
        </div>
    </div>
    <div class="w-full rounded-[12px] bg-white shadow-sm mt-[28px] flex flex-col p-[24px] gap-[40px]">
        <div class="flex items-center justify-center flex-col border-b-[1px] border-[#E5E7EB]">
            <h2 class="text-[20px] font-[600] text-[#000000] text-center break-auto-phrase">{{ __('Downgrade Details') }}</h2>
        ...
        <div class="grid grid-cols-2 border-b-[1px] border-[#E5E7EB]">
            <h2 class=" text-[20px] font-[400] text-[#000000] pb-[40px break-auto-phrase">{{ __('Balance Credited:') }}</h1>
            <p class="text-[20px] font-[600] text-blue pb-[40px] text-right break-auto-phrase"> {{ $credit_balance }}</p>
        </div>

        <div class="grid grid-cols-2 border-b-[1px] border-[#E5E7EB]">
            <h2 class=" text-[20px] font-[400] text-[#000000] pb-[40px break-auto-phrase">{{ __('Next Cycle Charge:') }}</h1>
            <p class="text-[20px] font-[600] text-blue pb-[40px] text-right break-auto-phrase"> {{ $next_payment }}</p>
        </div>
