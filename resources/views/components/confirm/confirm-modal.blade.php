@props([
    ...
    'btnConfirm' => __('admin.button.deactivate'),
    'modalType' => 'inactive',
])

<div x-show="showConfirm" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
    <!-- Background overlay -->
            ...
            <div class="confirm-modal-content">
                <div class="confirm-modal-content-box">
                    ...
                    <div class="confirm-modal-btn-box">
                        <button type="button" @click="$dispatch('close-cancel')" class="btn-box btn-blue-outline"
                            id="modal-cancel-button">
                            {{ $btnCancel }}
                        </button>
                        <button @click="$dispatch('close-confirm')" type="button" class="btn-box btn"
