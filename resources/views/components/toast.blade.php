 @props(['type' => 'success', 'message' => '', 'timestamp' => null, 'xShow'=>''])
 <div class="message-toaster-box" x-cloak>
     <div x-show="showToast" class="toaster-wrapper">
         <div class="toaster-content">

         <!-- Animated shrinking border -->
         <div class="absolute bottom-0 left-0 h-0.5 {{ $type === 'error' ? 'bg-red-600' : 'bg-green-600' }} animate-border-shrink"></div>
             ...
             <div class="icon">
                 ...
                 @elseif($type === 'warning')
                 <svg class="size-6 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                     <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                 </svg>
                 @elseif($type === 'info')
                 <svg class="size-6 text-blue-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
