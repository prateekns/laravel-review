...
<div class="pool-details-wrapper grid grid-cols-2 max-[1199px]:grid-cols-1">
    ...
    <div class="pool-detail-boxes flex-col">
        <div class="flex  w-[100%]" id="pool-size">
            ...
            <span
                class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600] w-[50%] max-[769px]:text-[14px] max-[769px]:text-right max-[767px]:font-[600]">{{ $poolDetails['pool_size_gallons'] ? $poolDetails['pool_size_gallons'] . ' ' . __('business.work_orders.gallons') : '' }}</span>
        </div>
        <div class="flex  w-[100%]" id="pool-type">
            ...
            <span
                class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600] w-[50%] max-[769px]:text-[14px] max-[769px]:text-right max-[767px]:font-[600]">{{ $poolDetails['pool_type'] }}</span>
        </div>
        ...
        <div class="flex  w-[100%]" id="clean-psi">
            ...
            <span
                class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600] w-[50%] max-[769px]:text-[14px] max-[769px]:text-right max-[767px]:font-[600]">{{ $poolDetails['clean_psi'] }}</span>
        </div>
        ...
        <div class="flex  w-[100%]" id="entry-instructions">
            ...
            <span
                class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600] w-[50%] max-[769px]:text-[14px] max-[769px]:text-right max-[767px]:font-[600]">{{ $poolDetails['entry_instruction'] }}</span>
        </div>
        ...
        <div class="flex  w-[100%]" id="tech-note">
            ...
            <span
                class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600] w-[50%] max-[769px]:text-[14px] max-[769px]:text-right max-[767px]:font-[600]">{{ $poolDetails['tech_notes'] }}</span>
        </div>
        ...
        <div class="flex  w-[100%]" id="admin-note">
            ...
            <span
                class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600] w-[50%] max-[769px]:text-[14px] max-[769px]:text-right max-[767px]:font-[600]">{{ $poolDetails['admin_notes'] }}</span>
        </div>
    </div>
    ...
    <div class="pool-detail-boxes flex-col">
        <div class="flex  w-[100%]" id="equipment-filter">
            ...
            <div class="flex items-center gap-2 w-[70%] justify-between">
                <span
                    class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600] ">{{ $poolDetails['filter_details'] }}</span>
                @if (!empty($poolDetails['equipment_images']->firstWhere('type', 'filter')))
                    <button type="button"
                        class="text-[12px] font-[400] text-[#086DF1] cursor-pointer whitespace-nowrap view-image-btn"
                        x-data
                        @click="$dispatch('open-modal', {
                                id: 'image-preview-modal',
                                url: '{{ $poolDetails['equipment_images']->firstWhere('type', 'filter')['url'] }}'
                            })">
        ...
        <div class="flex  w-[100%]" id="equipment-pump">
            ...
            <div class="flex items-center gap-2 w-[70%] justify-between">
                <span
                    class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600]">{{ $poolDetails['pump_details'] }}</span>
                @if (!empty($poolDetails['equipment_images']->firstWhere('type', 'pump')))
                    <button type="button"
                        class="text-[12px] font-[400] text-[#086DF1] cursor-pointer whitespace-nowrap view-image-btn"
                        x-data
                        @click="$dispatch('open-modal', {
                                id: 'image-preview-modal',
                                url: '{{ $poolDetails['equipment_images']->firstWhere('type', 'pump')['url'] }}'
                            })">
                        <span class="min-[768px]:inline-block max-[768px]:hidden">
                            {{ __('business.work_orders.view_image') }} </span>
                        <span class="max-[767px]:inline-block min-[768px]:hidden"><svg width="24" height="24"
        ...
        <div class="flex  w-[100%]" id="equipment-heater">
            ...
            <div class="flex items-center gap-2 w-[70%] justify-between">
                <span
                    class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600]">{{ $poolDetails['heater_details'] }}</span>
                @if (!empty($poolDetails['equipment_images']->firstWhere('type', 'heater')))
                    <button type="button"
                        class="text-[12px] font-[400] text-[#086DF1] cursor-pointer whitespace-nowrap view-image-btn"
                        x-data
                        @click="$dispatch('open-modal', {
                                id: 'image-preview-modal',
                                url: '{{ $poolDetails['equipment_images']->firstWhere('type', 'heater')['url'] }}'
                            })">
                        <span class="min-[768px]:inline-block max-[768px]:hidden">
                            {{ __('business.work_orders.view_image') }} </span>
                        <span class="max-[767px]:inline-block min-[768px]:hidden"><svg width="24" height="24"
        ...
        <div class="flex  w-[100%]" id="equipment-cleaner">
            ...
            <div class="flex items-center gap-2 w-[70%] justify-between">
                <span
                    class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600]">{{ $poolDetails['cleaner_details'] }}</span>
                @if (!empty($poolDetails['equipment_images']->firstWhere('type', 'cleaner')))
                    <button type="button"
                        class="text-[12px] font-[400] text-[#086DF1] cursor-pointer whitespace-nowrap view-image-btn"
                        x-data
                        @click="$dispatch('open-modal', {
                                id: 'image-preview-modal',
                                url: '{{ $poolDetails['equipment_images']->firstWhere('type', 'cleaner')['url'] }}'
                            })">
                        <span class="min-[768px]:inline-block max-[768px]:hidden">
                            {{ __('business.work_orders.view_image') }} </span>
                        <span class="max-[767px]:inline-block min-[768px]:hidden"><svg width="24" height="24"
        ...
        <div class="flex w-[100%]" id="equipment-salt-system">
            ...
            <div class="flex items-center gap-2 w-[70%] justify-between">
                <span
                    class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600]">{{ $poolDetails['salt_system_details'] }}</span>
                @if (!empty($poolDetails['equipment_images']->firstWhere('type', 'salt_system')))
                    <button type="button"
                        class="text-[12px] font-[400] text-[#086DF1] cursor-pointer whitespace-nowrap view-image-btn"
                        x-data
                        @click="$dispatch('open-modal', {
                                id: 'image-preview-modal',
                                url: '{{ $poolDetails['equipment_images']->firstWhere('type', 'salt_system')['url'] }}'
                            })">
                        <span class="min-[768px]:inline-block max-[768px]:hidden">
                            {{ __('business.work_orders.view_image') }} </span>
                        <span class="max-[767px]:inline-block min-[768px]:hidden"><svg width="24" height="24"
        ...
        <div class="flex w-[100%]" id="equipment-heat-pump">
            ...
            <div class="flex items-center gap-2 w-[70%] justify-between">
                <span
                    class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600]">{{ $poolDetails['heat_pump_details'] }}</span>
                @if (!empty($poolDetails['equipment_images']->firstWhere('type', 'heat_pump')))
                    <button type="button"
                        class="text-[12px] font-[400] text-[#086DF1] cursor-pointer whitespace-nowrap view-image-btn"
                        x-data
                        @click="$dispatch('open-modal', {
                                id: 'image-preview-modal',
                                url: '{{ $poolDetails['equipment_images']->firstWhere('type', 'heat_pump')['url'] }}'
                            })">
                        <span class="min-[768px]:inline-block max-[768px]:hidden">
                            {{ __('business.work_orders.view_image') }} </span>
                        <span class="max-[767px]:inline-block min-[768px]:hidden"><svg width="24" height="24"
        ...
        <div class="flex w-[100%]" id="equipment-aux-systems">
            ...
            <div class="flex items-center gap-2 w-[70%] justify-between">
                <span
                    class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600]">{{ $poolDetails['aux_details'] }}</span>
                @if (!empty($poolDetails['equipment_images']->firstWhere('type', 'aux')))
                    <button type="button"
                        class="text-[12px] font-[400] text-[#086DF1] cursor-pointer whitespace-nowrap view-image-btn"
                        x-data
                        @click="$dispatch('open-modal', {
                                id: 'image-preview-modal',
                                url: '{{ $poolDetails['equipment_images']->firstWhere('type', 'aux')['url'] }}'
                            })">
                        <span class="min-[768px]:inline-block max-[768px]:hidden">
                            {{ __('business.work_orders.view_image') }} </span>
                        <span class="max-[767px]:inline-block min-[768px]:hidden"><svg width="24" height="24"
        ...
        <div class="flex w-[100%]" id="equipment-aux-2-systems">
            ...
            <div class="flex items-center gap-2 w-[70%] justify-between">
                <span
                    class="text-[16px] font-[400] text-[#000000] max-[767px]:text-[14px] max-[767px]:font-[600]">{{ $poolDetails['aux2_details'] }}</span>
                @if (!empty($poolDetails['equipment_images']->firstWhere('type', 'aux2')))
                    <button type="button"
                        class="text-[12px] font-[400] text-[#086DF1] cursor-pointer whitespace-nowrap view-image-btn"
                        x-data
                        @click="$dispatch('open-modal', {
                                id: 'image-preview-modal',
                                url: '{{ $poolDetails['equipment_images']->firstWhere('type', 'aux2')['url'] }}'
                            })">
                        <span class="min-[768px]:inline-block max-[768px]:hidden">
                            {{ __('business.work_orders.view_image') }} </span>
                        <span class="max-[767px]:inline-block min-[768px]:hidden"><svg width="24" height="24"
